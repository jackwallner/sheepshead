...
/// drill flat; once each room grew a Sheepshead+ extra set that list ran to a dozen
...
struct HomeView: View {
    ...
    @StateObject private var minuteStore = SheepsheadMinuteStore.shared
    ...
    @AppStorage("sheepshead.hasReadPrimer") private var hasReadPrimer = false
    ...
    @AppStorage("sheepshead.recommendedRoomHint") private var recommendedRoomHint = ""
    ...
    var body: some View {
        NavigationStack(path: $path) {
            ...
            .sheet(isPresented: $showPaywall) { PaywallView(source: "sheepshead_home_sheet") }
    ...
    /// Progress is a ring, not a sentence. "2 of 3 done · 2 free, 1 with Sheepshead+"
    ...
    private func roomCard(_ room: Room) -> some View {
        ...
        // locked Sheepshead+ set in the denominator would mean a free player's ring
...
extension DrillKind {
    var symbol: String {
        ...
        case .discard: return "arrow.down.to.line.circle.fill"
        }
    }
