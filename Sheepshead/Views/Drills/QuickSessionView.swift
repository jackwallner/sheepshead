...
private enum QuickSessionPurpose {
    ...
    case dailyMinute(SheepsheadMinuteChallenge)
    case gameNightPrep

    var drill: Drill {
        switch self {
        case .quickSession: return SessionBuilder.sessionDrill
        case .dailyMinute: return SheepsheadMinuteContent.drill
...
struct QuickSessionView: View {
    ...
    init(sheepsheadMinute challenge: SheepsheadMinuteChallenge, onClose: (() -> Void)? = nil) {
    ...
    @State private var minuteResult: SheepsheadMinuteResult?
    ...
    private var completion: some View {
        if case .dailyMinute = purpose, let minuteResult {
            SheepsheadMinuteResultView(result: minuteResult, recordsCompletion: true, onDone: onClose)
        } else {
