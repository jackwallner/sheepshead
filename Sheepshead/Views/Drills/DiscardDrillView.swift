...
struct DiscardDrillView: View {
            ...
            CenteringScrollView {
                VStack(spacing: 18) {
                    ...
                    if submitted {
                        ...
                        Text("Selected \(selected.count) of 2")
                            .font(.subheadline)
    ...
    private var headline: String {
        switch matchCount {
        case 2: return "Perfect bury! 2 of 2"
        case 1: return "Close! 1 of 2 matches"
        ...
        Group {
            if submitted {
                Button {
                    ...
                    Text(index + 1 < scenarios.count ? "Next Holding" : "Finish").primaryCTA()
                }
            } else {
                Button {
                    submit()
                } label: {
                Text("Bury These 2").primaryCTA()
                }
