...
enum Theme {
    ...
    /// Serif display for titles , the "sheepshead club" voice.
...
extension Room {
    var accent: Color {
        ...
        case "trump-room": return Theme.coral
        case "bury-room": return Theme.plum
        case "trick-room": return Theme.jade
