...
final class AppSettings: ObservableObject {
    ...
    private static let reminderID = "sheepshead.dailyReminder"
    private static let gameNightReminderID = "sheepshead.gameNightReminder"
    ...
    private func scheduleReminder() {
        ...
        content.body = "Five minutes of practice keeps your choices calm and your card read sharp."
