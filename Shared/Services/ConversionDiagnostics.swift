...
/// On-device record of how someone met Sheepshead Plus before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.sheepshead", category: "Conversion")
    ...
    private static let impressionPrefix = "sheepshead_"
