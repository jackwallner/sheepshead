...
///
///     rc-funnel-attributes sheepshead --user <the id this run used>
final class PaywallFunnelUITests: XCTestCase {
    ...
    func testTestStorePurchaseRecordsTheConversion() {
        let probeUser = ProcessInfo.processInfo.environment["RC_PROBE_USER"]
            ?? "funnel-probe-sheepshead-uitest"
        ...
        let app = XCUIApplication(bundleIdentifier: "com.jackwallner.sheepshead")
