#!/usr/bin/env python3
"""Create the Sheepshead+ Lifetime non-consumable in App Store Connect.

Creates com.jackwallner.sheepshead.lifetime, adds the en-US localization, sets a
