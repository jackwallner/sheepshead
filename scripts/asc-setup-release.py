#!/usr/bin/env python3
"""One-time App Store Connect setup for Sheepshead: subscription group,
...
SUBS = [
    ...
    {
        "productId": "com.jackwallner.sheepshead.yearly",
        "name": "Sheepshead+ Yearly",
        "period": "ONE_YEAR",
        "price": "9.99",
...
REVIEW_NOTE = "Unlocks extra practice sets in every room and the Master Tables."
