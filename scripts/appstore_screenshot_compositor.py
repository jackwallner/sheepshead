...
warm cream + jade frame matching Sheepshead/Utilities/Theme.swift (serif
...
# MARK: - Theme (mirrors Sheepshead/Utilities/Theme.swift light-mode values)
...
WATERMARK_GLYPH = "♣"  # same glyph SheepsheadCardFace uses
...
SHOTS = [
    ...
    Shot(
        raw="02-trump.png",
        out="02_trump_room.png",
        eyebrow="THE TRUMP ROOM",
        headline="Read the holding, name the trump shape",
        accent=CORAL,
    ),
    Shot(
        raw="03-bury.png",
        out="03_bury_room.png",
        eyebrow="THE BURY ROOM",
        headline="Bury with a plan, learn the why",
        accent=GOLD,
    ),
    Shot(
        raw="04-trick.png",
        out="04_trick_room.png",
        eyebrow="THE TRICK ROOM",
        headline="Find the right play on the trick",
        accent=PLUM,
    ),
    Shot(
        raw="05-home.png",
...
def draw_background(img: Image.Image, accent: tuple) -> None:
    ...
    headline zone, plus the sheepshead-card watermark glyph bottom-right."""
